...
审计文件：`01-data/config.py`

- 当前生效代码没有使用绝对路径。
- `root_path` 当前由 `os.path.join(Path(__file__).parent.parent, "01-data")` 计算。
- 最终解析出的 `01-data` 绝对路径为：`D:\投满条配套资料\08-live_code\01-data`
- 文件中仍保留一行旧绝对路径注释：`D:\tmf_project_shenzhen_AI_4\07_live_code\01-data`，但该行未执行。
...
审计文件：`01-data/data_eda.py`

- 使用 `from config import Config` 导入配置类。
- 以脚本方式运行 `python 01-data\data_eda.py` 时，Python会把 `01-data` 加入脚本搜索路径，因此能正确导入同目录的 `config.py`。
...
| 配置项 | 解析路径 | 是否存在 |
|---|---|---|
| `root_path` | `D:\投满条配套资料\08-live_code\01-data` | 是 |
| `train_raw_path` | `D:\投满条配套资料\08-live_code\01-data\train_raw.txt` | 是 |
| `dev_raw_path` | `D:\投满条配套资料\08-live_code\01-data\dev_raw.txt` | 是 |
| `test_raw_path` | `D:\投满条配套资料\08-live_code\01-data\test_raw.txt` | 是 |
| `train_path` | `D:\投满条配套资料\08-live_code\01-data\train.txt` | 是 |
| `dev_path` | `D:\投满条配套资料\08-live_code\01-data\dev.txt` | 是 |
| `test_path` | `D:\投满条配套资料\08-live_code\01-data\test.txt` | 是 |
| `stopwords_path` | `D:\投满条配套资料\08-live_code\01-data\stopwords.txt` | 是 |
| `class_path` | `D:\投满条配套资料\08-live_code\01-data\class.txt` | 是 |
...
| 文件 | 行数 |
|---|---:|
| `01-data/train_raw.txt` | 180000 |
| `01-data/dev_raw.txt` | 10000 |
| `01-data/test_raw.txt` | 10000 |
| `01-data/train.txt` | 179000 |
| `01-data/dev.txt` | 9993 |
| `01-data/test.txt` | 9990 |
...
|---|---:|---:|---:|---:|
| `01-data/train_raw.txt` | 0 | 0 | 0 | 0 |
| `01-data/dev_raw.txt` | 0 | 0 | 0 | 0 |
| `01-data/test_raw.txt` | 0 | 0 | 0 | 0 |
| `01-data/train.txt` | 0 | 0 | 0 | 0 |
| `01-data/dev.txt` | 0 | 0 | 0 | 0 |
| `01-data/test.txt` | 0 | 0 | 0 | 0 |
...
| 文件 | 完整行重复数量 |
|---|---:|
| `01-data/train_raw.txt` | 1000 |
| `01-data/dev_raw.txt` | 7 |
| `01-data/test_raw.txt` | 10 |
| `01-data/train.txt` | 0 |
| `01-data/dev.txt` | 0 |
| `01-data/test.txt` | 0 |
...
运行命令：`$env:MPLBACKEND='Agg'; python '01-data\data_eda.py'`
...
- `config.py` 直接运行会覆盖 `train.txt`、`dev.txt`、`test.txt`，因此本轮没有执行 `python 01-data\config.py`。
