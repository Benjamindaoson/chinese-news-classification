...
- `rf_train_v2.py`: trains and writes `artifacts/random_forest/v2/tfidf_v2.pkl` and `rf_v2.pkl`.
...
See `reports/random_forest/v2/error_samples.csv`. RandomForest remains a sparse-feature baseline and should not be described as semantic understanding.
