...
model = fasttext.train_supervised(
    input = config.char_train_path, # 按字分词的训练集
    autotuneValidationFile = config.char_dev_path,  # 自动调参的验证集文件路径
...
model.save_model(config.ft_model_path.replace(".bin", "_char_2.bin"))
